...
namespace Almacen.Controllers
{
    public class AlmacenesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "iIdAlmacen,vchClave,vchNombre")] Almacenes almacenes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "iIdAlmacen,vchClave,vchNombre")] Almacenes almacenes)
        {
            if (ModelState.IsValid)
            {
